...
import com.sedwt.common.annotation.RedisCache;
...
public class RedisAspect {
	 ...
	 */
	@Pointcut("@annotation(com.sedwt.common.redis.annotation.RedisCache)")
	public void redisCachePoint() {
	}

	@Pointcut("@annotation(com.sedwt.common.redis.annotation.RedisEvict)")
				...
				if (obj == null) {
					...
					if (obj != null) {
						if (redisCache.expired() > 0) {
							RedisUtils.set(rk, obj, redisCache.expired());
						} else {
